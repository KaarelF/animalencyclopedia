from animal_subclasses import Mammal

raccoon = Mammal(
    name='Raccoon',
    introduction="The raccoon is a mammal native to North America. It is the largest of the procyonid family"
                 ", having a body length of 40 to 70 cm (16 to 28 in), and a body weight of 5 to 26 kg (11 to 57 lb). "
                 ...
                 "It is usually nocturnal and omnivorous, eating about 40% invertebrates, 33% plants, "
                 "and 27% vertebrates.",
    ...
    phylum='Chordata',
    class1='Mammalia',
    for_more='https://en.wikipedia.org/wiki/Raccoon'
)
